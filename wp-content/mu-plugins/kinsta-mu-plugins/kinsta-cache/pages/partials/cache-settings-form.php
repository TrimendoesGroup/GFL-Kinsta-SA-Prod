...
<form method="post">
    ...
    <div class='kinsta-box'>
        ...
        <fieldset class='mb22'>
            <legend class='kinsta-box-title-bar kinsta-box-title-bar__small mb22'><h3><?php _e( 'HTTPS Options', 'kinsta-cache' ) ?></h3></legend>

            <?php
            KinstaTools::kinsta_select_field(
                $this->KinstaCache->config['option_name'],
                'options[https]',
                $this->KinstaCache->settings['options']['https'],
                __( 'Does your site run on http or https?', 'kinsta-cache'),
                true,
                __( 'By default we will try to detect your http/https settings automatically. In some cases, due to Cloudflare or https forcing we may not be able to. In this case, please select your prefence manually.', 'kinsta-cache' ),
                array(
        ...
        <fieldset class='mb22'>
            ...
            <?php
                ...
                KinstaTools::kinsta_number_field(
                    ...
                    true,
                    sprintf( __( 'Set the number of blog pages to clear. If set to 3 it will clear the cache of %s and %s as well as the main blog. For more information <a href="'.KINSTA_CACHE_DOCS_URL.'">read the docs</a>', 'kinsta-cache' ), home_url() . '/page/2', home_url() . '/page/3' )
                );
                KinstaTools::kinsta_number_field(
                    $this->KinstaCache->config['option_name'],
